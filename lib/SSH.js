...
module.exports = function(spec) {
  ...
  if (spec.sudo_all !== false && !_.isEmpty(spec.sudo_all)) spec.sudo_all = JSON.parse(spec.sudo_all);
  ...
  obj.mkdir = function(args, callback) {
    args = args || {};
    args.owner = args.owner || spec.ssh_user;
    if (!args.owner && (args.sudo_all || spec.sudo_all)) args.owner = args.sudo_user || spec.sudo_user;
