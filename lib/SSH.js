...
//TODO: write meta logs like 'spawn child', 'master exit' etc. to a file, e.g., any2api-access.log to avoid polluting stdout

var spawn = function(command, cmdArgs, spawnArgs) {
  console.log('spawn child', command, cmdArgs, spawnArgs);
